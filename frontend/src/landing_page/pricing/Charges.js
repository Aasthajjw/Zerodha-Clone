function Charges() {
    return ( 
        <div className="Container mt-5 mb-3">
            <h3 className="text-center mb-3">Charges for Account Opening</h3>
            <table class="table border" style={{width: '80%', marginLeft: '10%'}}>
                <thead>
                    <tr>
                ...
                <h3 className="text-center mt-3 mb-3">Charges for optional value added services</h3>
                <table class="table border" style={{width: '80%', marginLeft: '10%'}}>
                    <thead>
                        <tr>
