...
function Brokerage() {
    ...
    <div className="container">
        ...
        <div className='row mt-5 mb-5'>
            <div className='col-md-6' style={{alignContent: 'space-between'}}>
                ...
                <p>₹100 per order for futures and options.<br/>For a non-PIS account, 0.5% or ₹100 per executed order for equity (whichever is lower).<br/>For a PIS account, 0.5% or ₹200 per executed order for equity (whichever is lower).<br/>₹500 + GST as yearly account maintenance charges (AMC) charges.</p>
                ...
                <p>Equity and Futures - ₹10 per crore + GST of the traded value.<br/>Options - ₹50 per crore + GST traded value (premium value).<br/>Currency - ₹0.05 per lakh + GST of turnover for Futures and ₹2 per lakh + GST of premium for Options.</p>
                <h6>Margin Trading Facility (MTF)</h6>
                <p>MTF Interest: 0.04% per day (₹40 per lakh) on the funded amount. The interest is applied from T+1 day until the day MTF stocks are sold. <br/>MTF Brokerage: 0.3% or Rs. 20/executed order, whichever is lower. <br/>MTF pledge charge: ₹15 + GST per pledge and unpledge request per ISIN.</p>
            </div>
            <div className='col-md-6' style={{alignContent: 'space-between'}}>
                <h6>GST</h6>
                ...
                <p>Delivery & MTF Brokerage: 0.5% per executed order.<br/>Intraday Brokerage: 0.05% per executed order.</p>
            </div>
        </div>
        <h6>Disclaimer</h6>
